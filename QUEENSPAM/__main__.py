...
from QUEENSPAM.utils import load_plugins
import logging
...
queen = "🎉 Successfully Deployed Queen SpamBot 🎉 @QUEEN_SPAM_BOT Enjoy! Do visit @QUEEN_SPAM_BOT"
print(queen[0: ])
